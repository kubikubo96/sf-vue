...
<template>
  <div class="container">
    ...
    <div>=============================================================</div>
    <div v-bind:id="id">
      Gan id bang V bind (v-bind: thêm thuộc tính vào thẻ)
    </div>
    <div :disabled="isDisabled">
      (v-bind: thêm thuộc tính vào thẻ) - viet tat
    </div>
    <div>=============================================================</div>
    <div :class="{ gan_class: selected, gan_class_2: selected_2 }">
      gan class
    </div>
    ...
    <TaskPage v-for="(task, index) in tasks" :key="index" :taskData="task" />
    <div>=============================================================</div>
    <div>Truyền data từ con lên cha</div>
    <div>hiện ở Cha: {{ dataShareChild }}</div>
    <TagSelector
      :dataShareChild="dataShareChild"
      @dataShareUpdate="updateDataShareFromChild"
    />
